      ...
      messages: [
        {
          role: "system",
          content:
            "Pick up where the user left off and complete the input text with generated sentences.Remember to write the user text as well.(do not include any introductory or explanatory phrases.)",
        },
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      if (modifiedOutputText.startsWith("Here is the completed text:")) {
        modifiedOutputText = modifiedOutputText
          .replace("Here is the completed text:", "")
          .trim();
      }
